...
<head>
	...
	<title>Arkademy Coffee Shop | Cashier</title>
</head>
...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-borderless rounded-lg shadow overflow-hidden">
						...
						<tbody>
							<?php foreach ($this->cashier->read() as $i=>$v){ ?>
							<tr>
	...
	<div class="modal fade" id="modal-add" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<form class="modal-content" method="POST" action="<?=base_url('/store/add_cashier')?>">
				...
				<div class="modal-body">
					<div class="form-group">
						<label for="product-name">Cashier Name</label>
	...
	<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<form class="modal-content" method="POST" action="<?=base_url('/store/edit_cashier')?>">
				<div class="modal-header">
	...
	<div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<form class="modal-content" method="POST" action="<?=base_url('/store/delete_cashier')?>">
				<div class="modal-header">
